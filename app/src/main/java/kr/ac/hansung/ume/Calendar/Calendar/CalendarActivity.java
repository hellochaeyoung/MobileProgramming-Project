...
public class CalendarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(intent.getStringExtra("position") != null) {
            changedPosition = Integer.parseInt(intent.getStringExtra("position"));
            positions.put(changedPosition, 0);
        }
    ...
    */
    ...
    public HashMap<Integer, Integer> getPositions(){ return positions; }
